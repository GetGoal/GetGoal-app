...
func GetConfig() Config {
	...
	log.Default().Printf("database_dbname %s", viper.GetString("database_dbname"))
	log.Default().Printf("database_sslmode %s", viper.GetString("database_sslmode"))
	log.Default().Printf("database_timezone %s", viper.GetString("database_timezone"))
